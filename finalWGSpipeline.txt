...
#13 phasing
os.system("java -Xmx8g -jar /BiO/Install/gatk-4.1.7.0/gatk-package-4.1.7.0-local.jar GenotypeGVCFs -R /BiO/Education/WGS/REF/hg19.fa -V {0}.rawVariants.g.vcf -O {0}_genotype.vcf".format(dataname))
...
#18-2 add annotation (snpeff,snpshift)
os.system("java -jar ~/snpEff/snpEff.jar -v hg19 {0}.filtered.variant.pass.vcf > {0}.snpEff.vcf".format(dataname))

os.system("java -jar /BiO/Access/home/hykim/YUHS/DATA2/snpEff/SnpSift.jar annotate /BiO/Education/WGS/REF/dbsnp_138.hg19.vcf {0}.snpEff.vcf > {0}.snpEff.dbSNP138.vcf".format(dataname))

os.system("java -jar /BiO/Access/home/hykim/YUHS/DATA2/snpEff/SnpSift.jar annotate /BiO/Education/WGS/REF/clinvar_20200706.vcf {0}.snpEff.dbSNP138.vcf > {0}.snpEff.dbSNP138.clinva.vcf".format(dataname))
